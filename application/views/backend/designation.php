					...
					<!-- Basic Inputs Validation start -->
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?php if (isset($editdesignation)) { echo 'Edit'; }else{echo 'Add';}?> Designation</h5>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form id="main" method="post" action="<?php if (isset($editdesignation)) { echo base_url().'organization/Update_des'; }else{ echo 'Save_des'; }?>" novalidate="">
