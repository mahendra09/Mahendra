                                                                ...
                                                                <tbody class="task-page">
																	...
																	<tr>
																		...
																		<select name="status" class="form-control form-control-sm">
																			...
																			<option value="running" <?php if($value->status == "running"){ echo 'Selected'; } ?>>Open</option>
																			<option value="complete" <?php if($value->status == "complete"){ echo 'Selected'; } ?>>Complate</option>
																			<option value="cancel" <?php if($value->status == "cancel"){ echo 'Selected'; } ?>>Cancle</option>
																		...
																		<?php foreach($assignvalue as $value1): ?>
																		 <a href="#"><img class="img-fluid img-radius" src="<?php echo base_url(); ?>assets/images/users/<?php echo $value1->em_image ?>" alt=""></a>
                                ...
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input type="text" name="startdate" placeholder="dd-mm-yyyy" class="form-control col-md-3 mydatetimepickerFull" id="recipient-name1">
                                                
                                                <label class="control-label col-md-2">Task End Date</label>
                                                <input type="text" name="enddate" placeholder="dd-mm-yyyy" class="form-control col-md-3 mydatetimepickerFull" id="recipient-name1">
                                            </div>
                                            <div class="form-group row">
