...
<div class="x_content">
					...
					<?php echo form_open_multipart('specialadmin/gallery/add','class="form-horizontal form-label-left"'); ?>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
							...
							<select name="g_category" required="required"  class="form-control col-md-7 col-xs-12">
								...
								?>
								<option value="<?php echo $gallerycategoryobj['gcname']; ?>"><?php echo $gallerycategoryobj['gcname']; ?></option>
								<?php } }?>
							</select>
						</div>
                      </div>
