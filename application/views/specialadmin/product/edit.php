...
<div class="x_content">
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Model No <span class="required">*</span>

                        </label>

                        <div class="col-md-6 col-sm-6 col-xs-12">

                          <input type="text" name="model_no" id="model_no"  value="<?php echo $product[0]['model_no']; ?>"  class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
							...
							<br><br>
							<input type="hidden" name="oldimg1" value="<?php echo $product[0]['p_img']; ?>">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
							...
							<br><br>
							<input type="hidden" name="oldimg" value="<?php echo $product[0]['p_img1']; ?>">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
							...
							<br><br>
						  <input type="hidden" name="oldimg3" value="<?php echo $product[0]['p_img2']; ?>">
