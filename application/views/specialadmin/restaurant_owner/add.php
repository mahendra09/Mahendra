...
<div class="x_content">
					...
					<?php echo form_open_multipart('specialadmin/restaurant_owner/add','class="form-horizontal form-label-left"'); ?>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="rname" id="rname" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="conno" id="conno"  pattern="[0-9 ]+" maxlength="10" minlength="10" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
