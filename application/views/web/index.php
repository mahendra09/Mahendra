    ...
    <section class="banner">
        ...
        <div class="container">
            <div class="banner_text_wthree_pvt">
                <h3 class="home-banner-w3">Employee Experience Platform</h3>

                <p class="bnr-txt">HR, Payroll and Talent Management for employee centric companies
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4 col-6">
                        <div class="bb-img">
                            <img src="<?php echo base_url(); ?>assets/web/images/a2.jpg" class="img-fluid img-thumbnail" alt="" />
                            <h3>caption goes here</h3>
                        </div>
                    </div>
                    <div class="col-sm-4 col-6">
                        <div class="bb-img">
                            <img src="<?php echo base_url(); ?>assets/web/images/a1.jpg" class="img-fluid img-thumbnail" alt="" />
                            <h3>caption goes here</h3>
                        </div>
                    </div>
                    <div class="col-sm-4 col-6 mx-auto mt-sm-0 mt-4">
                        <div class="bb-img">
                            <img src="<?php echo base_url(); ?>assets/web/images/a3.jpg" class="img-fluid img-thumbnail" alt="" />
                            <h3>caption goes here</h3>
                        </div>
                    </div>
                </div>
    ...
    <div class="wthree_pvtits-services align-w3" id="portfolio">
        <div class="container">
            ...
            <ul class="demo row">
                <li class="col-lg-3">
                    <div class="img-grid">
                        <div class="Portfolio-grid1">
                            <a href="#gal1">
                                <img src="<?php echo base_url(); ?>assets/web/images/g1.jpg" alt=" " class="img-fluid" />
                            </a>
                        </div>
                        <div class="port-desc text-center">
                            <h6 class="main-title-w3pvt text-center">Process Payroll</h6>
                            <p> Easiest Payroll for India. Fully integrated and unified workflow makes your payroll processing enjoyable.
                            </p>
                        </div>
                    </div>
                </li>
                <li class="col-lg-3">
                    <div class="img-grid">
                        <div class="Portfolio-grid1">
                            <a href="#gal2">
                                <img src="<?php echo base_url(); ?>assets/web/images/g2.jpg" alt=" " class="img-fluid" />
                            </a>
                        </div>
                        <div class="port-desc text-center">
                            <h6 class="main-title-w3pvt text-center">Manage Talent</h6>
                            <p> Talent administration made simple both for HR teams and employees alike. Your employees will love it.
                            </p>
                        </div>
                    </div>
                </li>
                <li class="col-lg-3">
                    <div class="img-grid">
                        <div class="Portfolio-grid1">
                            <a href="#gal3">
                                <img src="<?php echo base_url(); ?>assets/web/images/g3.jpg" alt=" " class="img-fluid" />
                            </a>
                        </div>
                        <div class="port-desc text-center">
                            <h6 class="main-title-w3pvt text-center">Nurture Talent</h6>
                            <p> Agile performance platform to engage talent with a blend of modern and traditional methods.
                            </p>
                        </div>
                    </div>
                </li>
                <li class="col-lg-3">
                    <div class="img-grid">
                        <div class="Portfolio-grid1">
                            <a href="#gal4">
                                <img src="<?php echo base_url(); ?>assets/web/images/g4.jpg" alt=" " class="img-fluid" />
                            </a>
                        </div>
                        <div class="port-desc text-center">
                            <h6 class="main-title-w3pvt text-center">Acquire Talent</h6>
                            <p> Hiring work horse to attract, acquire and engage your prospect employees. Hand made for India.
                            </p>
                        </div>
                    </div>
                </li>
            ...
            <div id="gal1" class="popup-effect animate">
                <div class="popup">
                    <img src="<?php echo base_url(); ?>assets/web/images/g1.jpg" alt="Popup Image" class="img-fluid" />
            ...
            <div id="gal2" class="popup-effect animate">
                <div class="popup">
                    <img src="<?php echo base_url(); ?>assets/web/images/g2.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="editContent mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int.
                        placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
            ...
            <div id="gal3" class="popup-effect animate">
                <div class="popup">
                    <img src="<?php echo base_url(); ?>assets/web/images/g3.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="editContent mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int.
                        placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
            ...
            <div id="gal4" class="popup-effect animate">
                <div class="popup">
                    <img src="<?php echo base_url(); ?>assets/web/images/g4.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="editContent mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int.
                        placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
            ...
            <div id="gal5" class="popup-effect animate">
                <div class="popup">
                    <img src="<?php echo base_url(); ?>assets/web/images/g5.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="editContent mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int.
                        placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
            ...
            <div id="gal6" class="popup-effect animate">
                <div class="popup">
                    <img src="<?php echo base_url(); ?>assets/web/images/g6.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="editContent mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int.
                        placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
            ...
            <div class="row space-sec">
                ...
                <div class="col-lg-4 col-md-6 mt-sm-0 mt-4">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="single.html">
                                <img class="card-img-bottom" src="<?php echo base_url(); ?>assets/web/images/g1.jpg" alt="Card image cap">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?php echo base_url(); ?>single.phps" class="blog_link">Read more</a>
                        </div>
                    </div>
                </div>
                <!-- //blog grid -->
                ...
                <div class="col-lg-4 col-md-6 mt-md-0  mt-4">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="single.html">
                                <img class="card-img-bottom" src="<?php echo base_url(); ?>assets/web/images/g2.jpg" alt="Card image cap">
                                <span class="post-icon">blog post</span>
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4 mx-auto blog-end">
                    <div class="card">
                        <div class="card-header p-0  position-relative">
                            <a href="single.html">
                                <img class="card-img-bottom" src="<?php echo base_url(); ?>assets/web/images/g3.jpg" alt="Card image cap">
                                <span class="post-icon">blog post</span>
                            </a>
                        </div>
                        <div class="card-body">
