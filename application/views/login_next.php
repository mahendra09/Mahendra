...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php if(isset($company) && !empty($company)){ if(!empty($company[0]['login_img'])){ echo base_url().'assets/images/'.$company[0]['login_img'];  }else{echo base_url().'assets/images/background/login-register.jpg';} }else{ echo base_url().'assets/images/background/login-register.jpg'; } ?>);">
         
        <div class="login-box card">
            <div class="card-body loginpage" style="padding: 30% 17px 70% 17px;">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="<?php echo base_url(); ?>login/Login_Auth">
                    <a href="javascript:void(0)" class="text-center db">
						...
						?>
									<img src="<?php echo base_url(); ?>assets/images/<?php echo $company[0]['logo']; ?>" style="width:100%;" alt="Home" />
								<?php }else{ ?>
									<img src="<?php echo base_url(); ?>assets/adminty/files/assets/images/logo.png" style="width:100%;background:#000;padding: 10px;" alt="Home" />
								<?php } ?>
							<?php }else{ ?>
								<img src="<?php echo base_url(); ?>assets/adminty/files/assets/images/logo.png" alt="Home" style="width:100%;background:#000;padding: 10px;" />
							<?php } ?>
