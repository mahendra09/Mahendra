...
class Organization extends CI_Controller {
    ...
    public function Department(){
        ...
        $data['department'] = $this->Alldata->DetailData('department',$where);
    ...
    if($this->session->userdata('user_login_access') != False) { 
       ...
       if ($this->form_validation->run() == FALSE) {
        ...
        redirect(base_url().'organization/Department' , 'refresh');
       }
        }
    else{
		redirect(base_url() , 'refresh');
    ...
    public function Designation(){
		...
		$comid=$this->session->userdata('company');
		$where=array('company'=>$comid);
        $data['designation'] = $this->Alldata->DetailData('designation',$where);
    ...
    public function Save_des(){
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            //echo "Successfully Added";
            $this->session->set_flashdata('feedback','Successfully Added');
            redirect(base_url().'organization/Designation' , 'refresh');
        }
        }
    else{
		redirect(base_url() , 'refresh');
